<div class="modal fade" id="addDentistModal{{$id}}" tabindex="-1" role="dialog" aria-labelledby="addDentist">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">{{ $id ? 'Edit' : 'Add' }} Dentist</h4>
            </div>
            <div class="modal-body">
                <form enctype="multipart/form-data" method="POST"
                      action="{{ url('admin/dentists/save') }}" class="form-horizontal row">
                    <div class="col-md-offset-1 col-md-10">
                        ...
                        <div class="col-sm-offset-1 col-sm-7 text-left">
                            ...
                            <div class="form-group {{ $errors->has('branch') ? 'has-error' : '' }}">
                                <label class="col-sm-12 text-left">Branch</label>
                                <div class="col-sm-12">
                                    @php
